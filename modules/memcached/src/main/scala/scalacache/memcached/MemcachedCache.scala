...
class MemcachedCache[F[_]](client: MemcachedClient, keySanitizer: MemcachedKeySanitizer = ReplaceAndTruncateSanitizer())(
  ...
  override type Underlying = MemcachedClient
  override val underlying: Underlying = client
...
object MemcachedCache {
  ...
  /**
    ...
    */
  def apply[F[_]: Async](implicit config: CacheConfig): MemcachedCache[F] =
  ...
  /**
    ...
    */
  def apply[F[_]: Async](addressString: String)(implicit config: CacheConfig): MemcachedCache[F] =
  ...
  /**
    ...
    */
  def apply[F[_]: Async](client: MemcachedClient)(implicit config: CacheConfig): MemcachedCache[F] =
