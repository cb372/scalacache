...
object GZippingJavaAnyBinaryCodec {
  ...
  /**
    ...
    */
  implicit def default[S <: Serializable](implicit ev: ClassTag[S]): GZippingJavaAnyBinaryCodec[S] =
    new GZippingJavaAnyBinaryCodec(CompressingCodec.DefaultSizeThreshold)(ev)
