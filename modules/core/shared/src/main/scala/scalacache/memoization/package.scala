...
package object memoization {
  ...
  /**
    ...
    */
  def memoize[A, Repr](f: => Future[A])(implicit scalaCache: ScalaCache[Repr],
                                        flags: Flags,
                                        ec: ExecutionContext,
                                        codec: Codec[A, Repr]): Future[A] =
    macro Macros.memoizeImpl[A, Repr]
  ...
  /**
    ...
    * @return a Future of the result, either retrieved from the cache or calculated by executing the function `f`
    */
  def memoize[A, Repr](ttl: Duration)(f: => Future[A])(implicit scalaCache: ScalaCache[Repr],
                                                       flags: Flags,
                                                       ec: ExecutionContext,
                                                       codec: Codec[A, Repr]): Future[A] =
    macro Macros.memoizeImplWithTTL[A, Repr]
  ...
  /**
    ...
    */
  def memoize[A, Repr](optionalTtl: Option[Duration])(f: => Future[A])(implicit scalaCache: ScalaCache[Repr],
                                                                       flags: Flags,
                                                                       ec: ExecutionContext,
                                                                       codec: Codec[A, Repr]): Future[A] =
    macro Macros.memoizeImplWithOptionalTTL[A, Repr]
  ...
  /**
    ...
    * @return the result, either retrieved from the cache or calculated by executing the function `f`
    */
  def memoizeSync[A, Repr](f: => A)(implicit scalaCache: ScalaCache[Repr], flags: Flags, codec: Codec[A, Repr]): A =
    macro Macros.memoizeSyncImpl[A, Repr]
  ...
  /**
    ...
    * @return the result, either retrieved from the cache or calculated by executing the function `f`
    */
  def memoizeSync[A, Repr](ttl: Duration)(
      f: => A)(implicit scalaCache: ScalaCache[Repr], flags: Flags, codec: Codec[A, Repr]): A =
    macro Macros.memoizeSyncImplWithTTL[A, Repr]
  ...
  /**
    ...
    * @return the result, either retrieved from the cache or calculated by executing the function `f`
    */
  def memoizeSync[A, Repr](optionalTtl: Option[Duration])(
      f: => A)(implicit scalaCache: ScalaCache[Repr], flags: Flags, codec: Codec[A, Repr]): A =
    macro Macros.memoizeSyncImplWithOptionalTTL[A, Repr]
}
