...
```
libraryDependencies += "com.github.cb372" %% "scalacache-cats-effect" % "0.23.0"
```
...
```
libraryDependencies += "com.github.cb372" %% "scalacache-monix" % "0.23.0"
```
...
```
libraryDependencies += "com.github.cb372" %% "scalacache-scalaz72" % "0.23.0"
```
