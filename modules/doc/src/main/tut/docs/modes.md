...
```
libraryDependencies += "com.github.cb372" %% "scalacache-cats-effect" % "0.24.0"
```
...
```
libraryDependencies += "com.github.cb372" %% "scalacache-monix" % "0.24.0"
```
...
```
libraryDependencies += "com.github.cb372" %% "scalacache-scalaz72" % "0.24.0"
```
