...
```
libraryDependencies += "com.github.cb372" %% "scalacache-guava" % "0.25.0"
```
...
```
libraryDependencies += "com.github.cb372" %% "scalacache-memcached" % "0.25.0"
```
...
```
libraryDependencies += "com.github.cb372" %% "scalacache-ehcache" % "0.25.0"
```
...
```
libraryDependencies += "com.github.cb372" %% "scalacache-redis" % "0.25.0"
```
...
```
libraryDependencies += "com.github.cb372" %% "scalacache-caffeine" % "0.25.0"
```
...
```
libraryDependencies += "com.github.cb372" %% "scalacache-cache2k" % "0.25.0"
```
...
```
libraryDependencies += "com.github.cb372" %% "scalacache-ohc" % "0.25.0"
```
